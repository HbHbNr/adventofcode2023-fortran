...
$(BIN)/day11a: $(OBJ)/day11a_main.o $(OBJ)/day11a.o $(OBJ)/util.o
$(BIN)/day11a_test_driver: $(OBJ)/day11a_test_driver.o $(OBJ)/day11a_test.o $(OBJ)/day11a.o $(OBJ)/util.o $(OBJ)/fruit.o

$(OBJ)/day11b.o: $(OBJ)/util.o
...
$(BIN)/day11b: $(OBJ)/day11b_main.o $(OBJ)/day11b.o $(OBJ)/util.o
$(BIN)/day11b_test_driver: $(OBJ)/day11b_test_driver.o $(OBJ)/day11b_test.o $(OBJ)/day11b.o $(OBJ)/util.o $(OBJ)/fruit.o
...
$(BIN)/day13b: $(OBJ)/day13b_main.o $(OBJ)/day13b.o $(OBJ)/util.o
$(BIN)/day13b_test_driver: $(OBJ)/day13b_test_driver.o $(OBJ)/day13b_test.o $(OBJ)/day13b.o $(OBJ)/util.o $(OBJ)/fruit.o
...
$(OBJ)/day20a.o: $(OBJ)/util.o $(OBJ)/class_intringbuffer.o
...
$(OBJ)/day21a.o: $(OBJ)/util.o $(OBJ)/class_intringbuffer.o
...
$(BIN)/day21a: $(OBJ)/day21a_main.o $(OBJ)/day21a.o $(OBJ)/util.o $(OBJ)/class_intringbuffer.o
$(BIN)/day21a_test_driver: $(OBJ)/day21a_test_driver.o $(OBJ)/day21a_test.o $(OBJ)/day21a.o $(OBJ)/util.o $(OBJ)/fruit.o $(OBJ)/class_intringbuffer.o

$(OBJ)/day21b.o: $(OBJ)/util.o $(OBJ)/class_intringbuffer.o
...
$(BIN)/day21b: $(OBJ)/day21b_main.o $(OBJ)/day21b.o $(OBJ)/util.o $(OBJ)/class_intringbuffer.o
$(BIN)/day21b_test_driver: $(OBJ)/day21b_test_driver.o $(OBJ)/day21b_test.o $(OBJ)/day21b.o $(OBJ)/util.o $(OBJ)/fruit.o $(OBJ)/class_intringbuffer.o
